...
export default async function ProviderLeadsPage({params}: Props) {
  ...
  return <ProviderFeaturePage status={account.provider.status} providerName={account.provider.name} provider={account.provider} featureKey="leads" href="/provider/leads" />;
}
