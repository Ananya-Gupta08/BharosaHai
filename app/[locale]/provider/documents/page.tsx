...
export default async function ProviderDocumentsPage({params}: Props) {
  ...
  return <ProviderFeaturePage status={account.provider.status} providerName={account.provider.name} provider={account.provider} documents={documents} featureKey="documents" href="/provider/documents" />;
}
